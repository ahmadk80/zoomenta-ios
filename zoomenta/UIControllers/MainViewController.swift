...
class MainViewController: BaseUICtrl {
    ...
    @IBAction func dra(_ sender: Any) {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        //  self.view.backgroundColor = #colorLiteral(red: 0.6683420944, green: 0.8421128979, blue: 0.02759111398, alpha: 1)
        ...
        showViewController(viewController: UINavigationController.self, storyboardId: "MainTabBarController")
    }
...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 0:
            // Home
            self.showViewController(viewController: UINavigationController.self, storyboardId: "MainTabBarController")
        case 1:
            // Scan
            self.showViewController(viewController: UINavigationController.self, storyboardId: "scanNavigationController")
        case 2:
            // Search
            self.showViewController(viewController: UINavigationController.self, storyboardId: "searchNavigationController")
        case 3:
            // View Profile
            self.showViewController(viewController: UINavigationController.self, storyboardId: "profileNavigationController")
        case 4:
            // View Profile
            showAlert(withTitle: "Coming Soon", message: "This feature will come soon")
        //        case 2:``
        //            // Movies
        //            self.showViewController(viewController: UINavigationController.self, storyboardId: "scanViewController")
        //        case 3:
        //            // Books
