...
//    @IBOutlet var footerLabel: UILabel!
    ...
    var menu: [SideMenuModel] = [
        ...
        SideMenuModel(icon: UIImage(systemName: "music.note")!, title: "Scan"),
        SideMenuModel(icon: UIImage(systemName: "film.fill")!, title: "Search"),
        SideMenuModel(icon: UIImage(systemName: "book.fill")!, title: "Profile"),
        SideMenuModel(icon: UIImage(systemName: "book.fill")!, title: "Returned Cards"),
...
extension SideMenuViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        myCustomSelectionColorView.backgroundColor = #colorLiteral(red: 0.4666666687, green: 0.7647058964, blue: 0.2666666806, alpha: 1)
